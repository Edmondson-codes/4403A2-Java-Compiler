...
public class StackMachine {
    ...
    public static final int NULL_ARRAY = 7;
    public static final int INVALID_ARRAY_LENGTH = 8;
    ...
    private void execInstruction() {
        ...
        switch (inst) {
            ...
            case ALLOC_HEAP -> {
                ...
                for (int i = limit; i < limit + size && running; i++) {
                    memory[i] = NULL_ADDR;
                }
            }
            case LOAD_MULTI -> {
            ...
            case STOP -> {
                ...
                runtimeError( switch (exitcode) {
                    ...
                    case NULL_ARRAY -> "null array access";
                    case INVALID_ARRAY_LENGTH -> "invalid array length";
