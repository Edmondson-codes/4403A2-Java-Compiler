...
public abstract class Type {
    ...
    public ArrayType getArrayType() {
        ...
        if (thisType instanceof ArrayType arrayType) {
            return arrayType;
        }
        return null;
    }
    ...
    public static class ArrayAttribute {
        ...
        /**
         * The type of the array attribute.
         */
        private Type type;
        /**
         * The offset of the array attribute from the start of the array,
         * if it is stored explicitly, or -1 otherwise.
         */
        private int offset;

        public ArrayAttribute(String name, Type type, int offset) {
            this.name = name;
            this.type = type;
            this.offset = offset;
        }

        public ArrayAttribute(String id, Type type) {
            this(id, type, -1);
        }
    ...
    /**
     * Type representing an array indexed by integers.
     * <p>
     * The length of an instance of an array will be fixed when the array is created.
     */
    public static class ArrayType extends FunctionType {
        /**
         * The length attribute of an array.
         */
        public static final ArrayAttribute LENGTH_ATTRIBUTE =
                new ArrayAttribute("length", Predefined.INTEGER_TYPE, 0);
        /**
        ...
        public ArrayType(Location loc, Type elementType) {
            super(loc, Predefined.INTEGER_TYPE, elementType);
            /* The value of an array is the absolute (i.e. global) address where the array
            length and elements are stored. */
            space = SIZE_OF_ADDRESS;
            this.resolved = false;
        }
